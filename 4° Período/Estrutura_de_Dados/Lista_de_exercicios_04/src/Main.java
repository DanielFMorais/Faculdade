...
public class Main {
    ...
    public static void main(String[] args) {
        ListaDuplamenteEncadeada lista = new ListaDuplamenteEncadeada(); // CORRIGIDO
        ...
        do {
            System.out.printf("""
            ----------
            Olá, vamos começar com nossa lista Duplamente Encadeada\n
            ...
            if (op == 1) { //Para entrada da função de adição no incio com tratativa de valores sem ser inteiros
                ...
                lista.adicionarMeio(b, a); // CORRIGIDO (ordem correta: posição, valor)
                ...
                lista.removerEspecifico(a);
            } else if (op == 8) { //Para entrada da função de identificar da posição com validação de posição se é inteiro 
                int a = lerInteiro(sc, "Qual Valor você gostaria de saber onde esta: ");
                lista.pesquisaPosicao(a);
